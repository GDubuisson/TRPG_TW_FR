...
import {TWActorSheet} from "./actors/actor-sheet.js"
...
Hooks.once("init", async function () {
    ...
    CONFIG.Actor.documentClass = CONFIG.Actor.documentClass || {};
    CONFIG.Actor.documentClass["personnage"] = TWActor;
    ...
    Actors.registerSheet("TRPG_TW_FR", TWActorSheet, {
        types: ["personnage"],
        makeDefault: true,
